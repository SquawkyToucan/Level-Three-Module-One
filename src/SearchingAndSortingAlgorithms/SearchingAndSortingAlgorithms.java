...
public class SearchingAndSortingAlgorithms {
	...
	public void testSearch() {
		...
		assertFalse(Algorithms.findBrokenEgg(eggs) == 2);
		List<String> eggs2 = Arrays.asList(new String[] {"whole", "whole", "whole", "whole"});
		assertEquals(-1, Algorithms.findBrokenEgg(eggs2));
	}
